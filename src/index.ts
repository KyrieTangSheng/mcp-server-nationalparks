...
import { npsApiClient, ParkData, AlertData } from './utils/npsApiClient.js';
// Check for API key
 ...
 */
function formatParkData(parkData: ParkData[]) {
 ...
 */
function formatParkDetails(park: ParkData) {
 ...
 */
function formatAlertData(alertData: AlertData[]) {
