 ...
 */
export function formatParkDetails(park) {
 ...
 */
export function formatVisitorCenterData(visitorCenterData) {
 ...
 */
export function formatCampgroundData(campgroundData) {
    return campgroundData.map(campground => {
        ...
        if (campground.amenities) {
            if (campground.amenities.trashRecyclingCollection)
                amenities.push('Trash/Recycling Collection');
            ...
            if (campground.amenities.internetConnectivity)
                amenities.push('Internet Connectivity');
            ...
            if (campground.amenities.cellPhoneReception)
                amenities.push('Cell Phone Reception');
            if (campground.amenities.laundry)
                amenities.push('Laundry');
            if (campground.amenities.amphitheater)
                amenities.push('Amphitheater');
            if (campground.amenities.dumpStation)
                amenities.push('Dump Station');
            if (campground.amenities.campStore)
                amenities.push('Camp Store');
            if (campground.amenities.staffOrVolunteerHostOnsite)
                amenities.push('Staff/Volunteer Host Onsite');
            ...
            if (campground.amenities.iceAvailableForSale)
                amenities.push('Ice Available For Sale');
            if (campground.amenities.firewoodForSale)
                amenities.push('Firewood For Sale');
            if (campground.amenities.foodStorageLockers)
                amenities.push('Food Storage Lockers');
        }
        return {
